...
public class LegalDocumentMCPServer {
  ...
  @Tool(name = "last_update_terms",
    description = "Returns the last time the TERMS AND CONDITIONS document was updated")
  LocalDate lastUpdateTerms(McpLog log) {
    log.info("lastUpdateTerms");
    return LocalDate.of(2014, 6, 19);
  }

  @Tool(name = "last_update_license_agreement",
    description = "Returns the last time the END USER LICENSE AGREEMENT document was updated")
